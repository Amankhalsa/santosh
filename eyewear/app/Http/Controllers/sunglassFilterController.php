...
class sunglassFilterController extends Controller
{
...
public function filter_product_for(Request $request)

    {
        ...
        $top_products = Category::where('category_status', 'Active')->where('category_frame', 'Sunglasses')->where('category_qty', '>', 0)->get();
        ...
        $arr = Category::where('category_status', 'Active')->where('category_frame', 'Sunglasses')->where('category_type', 'Product')->whereIn('category_for', $cat_for)->where('category_qty', '>', 0);
...
// ============================== main_cat end =======================
    ...
    public function gentle_man()
    {
        ...
        $arr = Category::where('category_for', '!=', 'Woman')->where('category_frame', 'Sunglasses')->where('category_qty', '>', 0)->where('category_status', 'Active')->get();
        $all_brands = Category::where('category_parent_id', '0')->where('category_status', 'Active')->get();
        $top_products = Category::where('category_status', 'Active')->where('category_is_top', 'Yes')->where('category_qty', '>', 0)->get();
        $frame_types = DB::table('product_attributes')->where('type', '!=', '')->get();
        $frame_shapes = DB::table('product_attributes')->where('shape', '!=', '')->get();
    ...
    public function woman()
    {
        $ip_country = $this->ip_country;
        $product_for = "Woman";
        $arr = Category::where('category_for', '!=', 'Gentle Man')->where('category_frame', 'Sunglasses')->where('category_qty', '>', 0)->where('category_status', 'Active')->get();
        $all_brands = Category::where('category_parent_id', '0')->where('category_status', 'Active')->get();
        $top_products = Category::where('category_status', 'Active')->where('category_is_top', 'Yes')->where('category_qty', '>', 0)->get();
        $frame_types = DB::table('product_attributes')->where('type', '!=', '')->get();
        $frame_shapes = DB::table('product_attributes')->where('shape', '!=', '')->get();
    ...
    public function junior()
    {
        $ip_country = $this->ip_country;
        $product_for = "Junior";
        $arr = Category::where('category_for', '!=', 'Junior')->where('category_frame', 'Sunglasses')->where('category_qty', '>', 0)->where('category_status', 'Active')->get();
        $all_brands = Category::where('category_parent_id', '0')->where('category_status', 'Active')->get();
        $top_products = Category::where('category_status', 'Active')->where('category_is_top', 'Yes')->where('category_qty', '>', 0)->get();
        $frame_types = DB::table('product_attributes')->where('type', '!=', '')->get();
        $frame_shapes = DB::table('product_attributes')->where('shape', '!=', '')->get();
...
// ======================= frame_type_men start==================================
...

    {
        ...
        $arr = Category::where('category_for', '!=', 'Woman')->where('category_frame', 'Sunglasses')->where('category_frame', $glass_type)->where('category_qty', '>', 0)->where('category_status', 'Active')->paginate(39);
...
// ======================= frame_type_men end ==================================
...

    {
        ...
        $arr = Category::where('category_for', '!=', 'Gentle Man')->where('category_frame', 'Sunglasses')->where('category_frame', $glass_type)->where('category_qty', '>', 0)->where('category_status', 'Active')->paginate(100);

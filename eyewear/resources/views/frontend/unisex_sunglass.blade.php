@if($unisex_sunglasses->isNotEmpty())
...
<div class="productColMain">
   ...
   <!--Eyeglasses header   -->
            <div class="row g-4">
@foreach($unisex_sunglasses as $product)
@php
...
<a  class="btn btnDark_outline w-100 add_to_wishlist" >
  ADD TO WISHLIST</button>
            ...
            <div class="btnCol text-center">
              <a href="{{url('/eyeglasses/men')}}" target="_blank" class="btn btnPrimary minWdBtn btnNew">Shop Now</a>
            </div>
          </div>
          @endif
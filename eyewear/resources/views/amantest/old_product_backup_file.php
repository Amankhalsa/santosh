...
<button type="button" class="btn btn-info" onclick="addLensCart('{{$product_data->id}}')">
Buy with Lens</button>

@else
<button type="button" class="button-sun-01" disabled style="cursor:no-drop;background-color:#bdbdbd">
Buy with Lens</button>
@endif

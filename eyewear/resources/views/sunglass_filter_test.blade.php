...
@php
 ...
 $meta_title = (!empty($meta_tag->page_meta_title)) ? $meta_tag->page_meta_title : "Sunglass";

 $meta_description = (!empty($meta_tag->page_meta_description)) ? $meta_tag->page_meta_description : "Sunglass Meta Description";

 $meta_keywords = (!empty($meta_tag->page_meta_keywords)) ? $meta_tag->page_meta_keywords : "Sunglass Meta Keywords";
            ...
            <div class="container">
                ...
                <div class="brand_banner_content">
                    ...
                    <div class="brand_banner_content_text text-center">
                        ...
                        <h1 class="brand_bannner_head">Sunglass</h1>
                        ...
                        <nav aria-label="breadcrumb">
                            ...
                            <ol class="breadcrumb breadcrumbStyle justify-content-center">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Sunglass</li>

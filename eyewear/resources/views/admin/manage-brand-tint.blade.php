...
@section('title','Manage Brand Tint')
...
<div class="row">
<div class="col-lg-12">
<h4 style="float:left;margin-top:5px;">Manage Brand Tint &nbsp; <i style="font-size:20px;" class="fas fa-list-alt"></i></h4>
...
<span><a href="{{ route('manage-lens-brand') }}" class="btn btn-info" style="font-size:15px"><i class="fa fa-angle-double-left"></i> Back</a></span>
&nbsp;&nbsp;


<span><a href="{{ route('add-brand-tint-form', $category_parent_id) }}" class="btn btn-primary"> <i class="fa fa-plus"></i> Add</a></span>
...
@if($subcategories->isNotEmpty())
 ...
 <form action="{{ route('bottom-button-action-brand-tint', $category_parent_id) }}" method="post" onsubmit="return checkboxValidation()">
  @csrf
  @method('PUT')
  ...
  <div class="row">
        ...
        <li class="breadcrumb-item">{{ $cat_name->category_name }}</li>
        @endif
     ...
     @foreach($subcategories as $subcategory_data)
        ...
        <img src="{{ asset('/uploaded_files/lens/'.$subcategory_data->category_image_name) }}" style="width:80%;height:100px;" alt="category image" title="category image" class="rounded">
         @else
        ...
        <!--<a href="{{route('manage-tint-color',[$category_parent_id,$subcategory_data->id])}}">-->
        ...
        <td class="text-center v-align">
        <a title="Edit brand tint" href="{{ route('edit-brand-tint', [$category_parent_id, $subcategory_data->id]) }}" data-toggle="tooltip"><i class="fa fa-edit"></i></a>

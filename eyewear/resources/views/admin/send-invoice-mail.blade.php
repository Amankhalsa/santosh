...
<h1>Your have received your order invoice from {{$admin_data->admin_company_name}}.<br></h1>
</td>
</tr>
<tr>
<td class="esd-block-text es-p5t es-p5b es-p40r es-p40l" align="center">
<p style="color: #333333;">If you have any questions, Call us {{$admin_data->admin_mobile}}.

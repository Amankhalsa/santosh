...
@section('title','Manage Brand Coating')
...
<div class="row">
<div class="col-lg-12">
<h4 style="float:left;margin-top:5px;">Manage Brand Coating &nbsp; <i style="font-size:20px;" class="fas fa-list-alt"></i></h4>
...
<span><a href="{{ route('add-brand-coating-form', $category_parent_id) }}" class="btn btn-primary"> <i class="fa fa-plus"></i> Add</a></span>
...
@if($subcategories->isNotEmpty())
 ...
 <form action="{{ route('bottom-button-action-brand-coating', $category_parent_id) }}" method="post" onsubmit="return checkboxValidation()">
  @csrf
  @method('PUT')
  ...
  <div class="row">
     ...
     @foreach($subcategories as $subcategory_data)
       ...
       <td class="text-center">
        ...
        <img src="{{ asset('/uploaded_files/lens/'.$subcategory_data->category_image_name) }}" style="width:40%;height:100px;" alt="category image" title="category image" class="rounded">
         @else
        ...
        <td class="text-center v-align">
        <a title="Edit brand coating" href="{{ route('edit-brand-coating', [$category_parent_id, $subcategory_data->id]) }}" data-toggle="tooltip"><i class="fa fa-edit"></i></a>

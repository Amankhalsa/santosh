...
@section('title','Manage Lens Brand')
...
<div class="row">
<div class="col-lg-12">
<h4 style="float:left;margin-top:5px;">Manage Lens Brand &nbsp; <i style="font-size:20px;" class="fas fa-list-alt"></i></h4>

<div style="float:right;">
<span style="padding:8px;font-size:16px;box-shadow:2px 2px 2px grey;" class="badge badge-pill badge-secondary"><b>Total:</b> {{ $lens_brands->total() }}</span>
&nbsp;&nbsp;
<span><a href="{{ route('add-lens-brand') }}" class="btn btn-primary"> <i class="fa fa-plus"></i> Add Lens Brand</a></span>
...
@if($lens_brands->isNotEmpty())
 ...
 <form action="{{ route('bottom-button-action-lens-brand') }}" method="post" onsubmit="return checkboxValidation()">
  @csrf
  @method('PUT')
  ...
  <div class="row">
        ...
        <ol class="breadcrumb" id="breadcrumb_cat">
            <strong>Lens Brand </strong> &nbsp; Details
        </ol>
        </nav>
        </div>
     ...
     $status="";
     @endphp
     @foreach($lens_brands as $category_data)
        ...
        <img src="{{ asset('/uploaded_files/lens/'.$category_data->category_image_name) }}" style="width:50%;height:100px;" alt="category image" title="category image" class="rounded">
         @else
         <img src="{{ asset('admin_assets/images/no_image.jpg') }}" style="width:50%;height:90px;" alt="category" title="category" class="rounded"/>
         @endif
    ...
    @endif
        ...
        <td class="text-center v-align">
         {{ $category_data->category_name }} <br>
        
        <a href="{{ route('manage-brand-coating', $category_data->id) }}" title="View Coating" data-toggle="tooltip">View Coating</a>
        </td>

        
        <td class="text-center v-align">
        <a href="{{ route('add-brand-coating-form', $category_data->id) }}" title="Add Brand Coating" data-toggle="tooltip" class="btn btn-outline-secondary"> <i class="fas fa-plus"></i> Coating </a>
        </td>
        ...
        <td class="text-center v-align">
        <a title="Edit Lens Brand" href="{{ route('edit-lens-brand', $category_data->id) }}" data-toggle="tooltip"><i class="fa fa-edit"></i></a>

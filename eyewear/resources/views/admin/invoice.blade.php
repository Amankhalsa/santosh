...
<tr>
    <td><b>Customer Detail :</b><hr>
       ...
       @if(!empty($user_data->state)) 
        @php
         $state_name=DB::table('states')->where('id',$user_data->state)->first();
        @endphp
        {{$state_name->name}} - {{$user_data->pincode}}
       @endif 
       @if(!empty($user_data->country)) 
        @php
         $country_name=DB::table('countries')->where('id',$user_data->country)->first();
        @endphp
        {{$country_name->name}}
       @endif 
    </td>

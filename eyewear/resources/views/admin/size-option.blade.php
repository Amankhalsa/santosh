...
@section('title','Manage Size Option')
...
<div class="row">
<div class="col-lg-12">
<h4 style="float:left;margin-top:5px;">Manage Size Option &nbsp; <i style="font-size:20px;" class="fas fa-asterisk"></i></h4>

<div style="float:right;">
<span style="padding:8px;font-size:16px;box-shadow:2px 2px 2px grey;" class="badge badge-pill badge-secondary"><b>Total:</b> {{ count($size_options) }}</span>
&nbsp;&nbsp;
...
<span><a href="{{ route('add-size-option-form', [$category_parent_id, $sub_cat_id, $final_cat_id, $product_id]) }}" class="btn btn-primary"> <i class="fa fa-plus"></i> Add Size Option</a></span>
...
@if($size_options->isNotEmpty())

 <div class="container-fluid">
  <form action="{{ route('bottom-button-size-option',[$category_parent_id,$sub_cat_id,$final_cat_id,$product_id]) }}" method="post" onsubmit="return checkboxValidation()">
  @csrf
  @method('PUT')
  <div class="row">
     ...
     $status="";
     @endphp
     @foreach($size_options as $size_data)
        <tr>
        ...
        <td class="text-center v-align">
        <a title="Edit Size Option" href="{{ route('edit-size-option',[$category_parent_id,$sub_cat_id,$final_cat_id,$product_id,$size_data->id]) }}" data-toggle="tooltip"><i class="fa fa-edit"></i></a>

...
?> 
      ...
      <ul>
          <!---------------->
<?php $__currentLoopData = $get_color_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $color_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <!------------------->
        <li>
          <span class="filterChek">
            <input type="checkbox" class="btn-check" id="btncheck-01" autocomplete="off">
            <label class="btn colorBtn" for="btncheck-01">
                <img src="<?php echo e(asset('uploaded_files/color_image/'.$color_data->color_image_name)); ?>" alt="...">
                </label>
          </span>
        </li>
 ...
 <!--sidebar end --><?php /**PATH /home2/luxurjhf/public_html/eyewear/resources/views/filter_side_bar.blade.php ENDPATH**/ ?>
              ...
              <div class="row align-items-center">
                <div class="col-lg-6">
                  <div class="testimonialImgCol">
                    <img src="<?php echo e(asset('uploaded_files/assets/images/lg-dots.svg')); ?>" alt="..." class="testimonialDotsImg">
                    <span class="testimonialUserImg">
                      <img src="<?php echo e(asset('uploaded_files/assets/images/testimonial-img.jpg')); ?>" alt="...">
                    </span>
                  </div>
                </div>
                <div class="col-lg-6">
              ...
              <div class="row align-items-center">
                <div class="col-lg-6">
                  <div class="testimonialImgCol">
                    <img src="<?php echo e(asset('uploaded_files/assets/images/lg-dots.svg')); ?>" alt="..." class="testimonialDotsImg">
                    <span class="testimonialUserImg">
                      <img src="<?php echo e(asset('uploaded_files/assets/images/testimonial-img2.jpg')); ?>" alt="...">
                    </span>
                  </div>
                </div>
                <div class="col-lg-6">
              ...
              <div class="row align-items-center">
                <div class="col-lg-6">
                  <div class="testimonialImgCol">
                    <img src="<?php echo e(asset('uploaded_files/assets/images/lg-dots.svg')); ?>" alt="..." class="testimonialDotsImg">
                    <span class="testimonialUserImg">
                      <img src="<?php echo e(asset('uploaded_files/assets/images/testimonial-img3.jpg')); ?>" alt="...">
                    </span>
                  </div>
                </div>
                <div class="col-lg-6">
...
<?php /**PATH /home2/luxurjhf/public_html/eyewear/resources/views/footer_what_about.blade.php ENDPATH**/ ?>
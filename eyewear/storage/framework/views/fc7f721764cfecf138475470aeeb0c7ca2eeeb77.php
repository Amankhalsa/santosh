...
.iframe-rwd iframe {position: absolute;top: 0;left: 0;width: 100%;height: 100%;}
    ...
    <hr>
      <?php if(session('form_success')): ?>
      <div class="alert alert-success alert-dismissible fade show">
      <button type="button" class="close" data-dismiss="alert">&times;</button>
      <?php echo e(session('form_success')); ?>
...
<form class="wpcf7-form" method="post" action="<?php echo e(url('/contact-form-submit')); ?>" role="form" enctype="multipart/form-data" name="contact-form">
    <?php echo csrf_field(); ?>
...
<!-- .form-group-->
    ...
    <hr>
    <address>
    <?php echo e($admin_data->admin_address); ?> <?php echo e($admin_data->admin_city); ?>, <?php echo e($admin_data->admin_state); ?> - <?php echo e($admin_data->admin_zip_code); ?>, <?php echo e($admin_data->admin_country); ?>
    ...
    <ul class="list-unstyled operation-hours inner-right-md">
      ...
      <span class="pull-right flip hours"><?php echo e($admin_data->email); ?> 
        <?php if(!empty($admin_data->admin_alternate_email)): ?>,<?php echo e($admin_data->admin_alternate_email); ?><?php endif; ?>
      </span>
      </li>

      <li class="clearfix">
      <span class="day">Mobile:</span>
      <span class="pull-right flip hours"><?php echo e($admin_data->admin_mobile); ?>

        <?php if(!empty($admin_data->admin_phone)): ?>,<?php echo e($admin_data->admin_phone); ?> <?php endif; ?>
      </span>
      </li>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/luxurjhf/public_html/eyewear/resources/views/contact-us.blade.php ENDPATH**/ ?>
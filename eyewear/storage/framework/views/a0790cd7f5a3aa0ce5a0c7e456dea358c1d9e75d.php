<?php if($male_eyeglasses->isNotEmpty()): ?>
...
<img src="<?php echo e(asset('uploaded_files/product/'.$product->category_image_name)); ?>" alt="image of <?php echo e($brand->category_name); ?>">
<?php else: ?>
...
?>        
<li>
<a href="<?php echo e(url('/frame/'.$product->category_slug_name.'.html')); ?>"  class="colorCol actColor btn-tool <?php if($group->category_slug_name==$product->category_slug_name): ?> color-btn <?php endif; ?>">
...
<?php else: ?>
<li>
<a href="<?php echo e(url('/frame/'.$product->category_slug_name.'.html')); ?>" target="_blank"  class="colorCol" >
...
<?php endif; ?>
       ...
       <a href="<?php echo e(url('/frame/'.$product['category_slug_name'].'.html')); ?>" class="btn btnDark w-100 addCartBtn">ADD TO CART</a>
            ...
            <div class="btnCol text-center">
              <a href="<?php echo e(url('/eyeglasses/men')); ?>" class="btn btnPrimary minWdBtn btnNew">Shop Now</a>
            </div>
          </div>
          <?php endif; ?><?php /**PATH /home2/luxurjhf/public_html/eyewear/resources/views/frontend/male_eyeglass.blade.php ENDPATH**/ ?>
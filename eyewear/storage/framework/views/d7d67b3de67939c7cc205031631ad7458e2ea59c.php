    ...
    <!-- Main CSS-->
    <link href="<?php echo e(asset('admin_assets/css/custom.css')); ?>" rel="stylesheet" media="all">
    <link href="<?php echo e(asset('admin_assets/css/theme.css')); ?>" rel="stylesheet" media="all">

    <link rel="stylesheet" href="https://cdn.datatables.net/1.10.21/css/dataTables.bootstrap4.min.css">
<?php /**PATH /home2/luxurjhf/public_html/eyewear/resources/views/admin/layouts/head.blade.php ENDPATH**/ ?>
              ...
              <div class="col-xl-auto col-lg-12 col-sm-12 ">
                <div class="foot_logo_content">
                  <div class="footer_logo">
                    <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('uploaded_files/assets/images/footer_new_logo.png')); ?>" alt="..."></a>
                  </div>
                  ...
                  <ul class="foot_social_icon">
                    <li><a href="javascript:void(0)"><img src="<?php echo e(asset('uploaded_files/assets/images/foot_facebook_icon.svg')); ?>" alt="..."></a></li>
                    <li><a href="javascript:void(0)"><img src="<?php echo e(asset('uploaded_files/assets/images/foot_twitter_icon.svg')); ?>" alt="..."></a></li>
                    <li><a href="javascript:void(0)"><img src="<?php echo e(asset('uploaded_files/assets/images/foot_instagram_icon.svg')); ?>" alt="..."></a></li>
                    <li><a href="javascript:void(0)"><img src="<?php echo e(asset('uploaded_files/assets/images/foot_linkedin_icon.svg')); ?>" alt="..."></a></li>
                    <li><a href="javascript:void(0)"><img src="<?php echo e(asset('uploaded_files/assets/images/foot_youtube_icon.svg')); ?>" alt="..."></a></li>
                  </ul>
                </div>
              </div>
              <div class="col">
...
?>  
 ...
 <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <li><a href="<?php echo e(url('/'.$page->page_link.'.html')); ?>"><?php echo e($page->page_name); ?></a></li>
                    ...
                    <div class="col-lg-auto">
                      <div class="imp_links_col add_cont">
                        ...
                        <ul class="foot_link_list contact">
                          ...
                          <li><a href="tel:<?php echo e($admin_data->admin_mobile); ?>"><img src="<?php echo e(asset('uploaded_files/assets/images/phone-icon.svg')); ?>" alt="..." style="width:30px;">9990360806</a></li>
                          <li><a href="mailto:<?php echo e($admin_data->admin_email); ?>"><img src="<?php echo e(asset('uploaded_files/assets/images/email_icon.svg')); ?>" alt="..." style="width:30px;">Support@Luxuryeyewear.In</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
              ...
              <div class="row align-items-center gy-4">
                <div class="col-xl col-lg-12 ">
                  <div class="courier_logo justify-content-center">
                    <ul>
                      <li><a href="javascript:void(0)"><img src="<?php echo e(asset('uploaded_files/assets/images/dhl_icon.png')); ?>" alt="..."></a></li>
                      <li><a href="javascript:void(0)"><img src="<?php echo e(asset('uploaded_files/assets/images/fedex_icon.png')); ?>" alt="..."></a></li>
                      <li><a href="javascript:void(0)"><img src="<?php echo e(asset('uploaded_files/assets/images/ups_icon.png')); ?>" alt="..."></a></li>
                      <li><a href="javascript:void(0)"><img src="<?php echo e(asset('uploaded_files/assets/images/aramex_icon.png')); ?>" alt="..."></a></li>
                    </ul>
                  </div>
                </div>
                <div class="col-xl-auto col-lg-12">
                  <div class="payment_method_logo">
                    <ul>
                      <li><a href="javascript:void(0)"><img src="<?php echo e(asset('uploaded_files/assets/images/visa.png')); ?>" alt="..."></a></li>
                      <li><a href="javascript:void(0)"><img src="<?php echo e(asset('uploaded_files/assets/images/mastercard.png')); ?>" alt="..."></a></li>
                      <li><a href="javascript:void(0)"><img src="<?php echo e(asset('uploaded_files/assets/images/american-express.png')); ?>" alt="..."></a></li>
                      <li><a href="javascript:void(0)"><img src="<?php echo e(asset('uploaded_files/assets/images/paypal.png')); ?>" alt="..."></a></li>
                    </ul>
                  </div>
                </div>
                <div class="col-xl-auto col-md-12 order-xl-first">
                  <p class="mb-xl-0">Copyright © <?php echo e(date('Y')); ?> by luxuryeyewear. All Rights reserved</p>
                </div>
              </div>
            </div>
          </div>
...
<form class="wpcf7-form" method="post" action="<?php echo e(url('/contact-form-submit')); ?>" role="form" enctype="multipart/form-data" name="contact-form-popup">
    <?php echo csrf_field(); ?>
  
    
<input type="hidden" name="source" value="<?php echo e(Request::path()); ?>">
...
<script type="text/javascript" src="<?php echo e(asset('webslidemenu/webslidemenu.js')); ?>"></script>
<script type="text/javascript">var site_url='<?php echo e($admin_data->admin_website_url); ?>';</script>
...
<script type="text/javascript" src="<?php echo e(asset('js/buywithlens.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(asset('js/multistep.min.js')); ?>"></script>
...
<script>
    ...
    var success_msg = '<?php echo e(Session::get('success_msg')); ?>';
    var success_msg_exist = '<?php echo e(Session::has('success_msg')); ?>';
    ...
    var error_msg = '<?php echo e(Session::get('error_msg')); ?>';
    var error_msg_exist = '<?php echo e(Session::has('error_msg')); ?>';
    if(error_msg_exist){
      Swal.fire({
      text: error_msg,
      icon: 'error'
...
<script>
        $(document).ready(function () {
            ...
            $('.add_to_wishlist').on('click',function(){
                ...
                $.ajax({
                type: "POST",
                url: "<?php echo e(route('add_to_wishlist')); ?>",
...
<script src="<?php echo e(asset('js/contact-validation.js')); ?>"></script>
<!-- JAVASCRIPT FILES -->
<script>
    $(document).ready(function(){
  $("#pre").click(function(){
...
<!--========== new js ===========-->
  ...
  <script src="<?php echo e(asset('js/new/bootstrap.bundle.min.js')); ?>"></script>
  <script src="https://unpkg.com/swiper/swiper-bundle.min.js"></script>
  <script src="<?php echo e(asset('js/new/script.js')); ?>"></script>
...
<?php /**PATH /home2/luxurjhf/public_html/eyewear/resources/views/layouts/footer.blade.php ENDPATH**/ ?>
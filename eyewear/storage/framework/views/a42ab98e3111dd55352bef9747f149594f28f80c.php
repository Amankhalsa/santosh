<?php if($male_sunglasses->isNotEmpty()): ?>
       ...
       <a href="<?php echo e(url('/frame/'.$product['category_slug_name'].'.html')); ?>" class="btn btnDark w-100 addCartBtn">ADD TO CART</a>
                      ...
                      <div class="col">
                        <form action="<?php echo e(url('/add-wishlist')); ?>" method="post">
                            ...
                            <a class="btn btnDark_outline w-100 add_to_wishlist" >ADD TO WISHLIST
                              </a>
                        </form>   
          ...
          <?php endif; ?><?php /**PATH /home2/luxurjhf/public_html/eyewear/resources/views/frontend/male_sunglass.blade.php ENDPATH**/ ?>